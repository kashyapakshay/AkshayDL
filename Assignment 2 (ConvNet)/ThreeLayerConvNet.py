...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7, learning_rate=0.01,
    ...
    def loss(self, X, y=None):
        ...
        out_2, cache_2 = self.affine_relu_forward(out_1, W2, b2)
        ...
        print '[2] Affine_ReLU'
        dx_2, grads['W2'], grads['b2'] = self.affine_relu_backward(dx_3, cache_2)
...
if __name__ == '__main__':
    ...
    convNet = ThreeLayerConvNet(epochs=10, learning_rate=0.01) # create an SVN classifier class
    ...
    #     print np.argmax(predictions[i]), ' - ', Yte[i]
